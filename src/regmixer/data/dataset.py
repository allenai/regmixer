...
class MixtureBuilder:
    ...
    def build(self) -> SourceMixtureDatasetConfig:
        source_configs: SourceMixtureList = SourceMixtureList(sources=[]) # List[SourceMixtureConfig] = []
        ...
        return SourceMixtureDatasetConfig(
            ...
            global_batch_size=self.global_batch_size, #fix? 
            #sequence_length=self.sequence_length, #fix?
            seed=self.seed,
            #dtype=self.dtype,
