...
class GroupedWandbMetrics(Enum):
    mmlu_bpb = [
        WandbMetrics.mmlu_humanities_bpb,
        WandbMetrics.mmlu_humanities_var_bpb,
        WandbMetrics.mmlu_other_bpb,
        WandbMetrics.mmlu_other_var_bpb,
        WandbMetrics.mmlu_social_sciences_bpb,
        WandbMetrics.mmlu_social_sciences_var_bpb,
        WandbMetrics.mmlu_stem_bpb,
        WandbMetrics.mmlu_stem_var_bpb,
    ]
    mmlu_len_norm = [
        WandbMetrics.mmlu_humanities_mc_5shot_len_norm,
        WandbMetrics.mmlu_humanities_mc_5shot_test_len_norm,
        WandbMetrics.mmlu_humanities_var_len_norm,
        WandbMetrics.mmlu_other_mc_5shot_len_norm,
        WandbMetrics.mmlu_other_mc_5shot_test_len_norm,
        WandbMetrics.mmlu_other_var_len_norm,
        WandbMetrics.mmlu_social_sciences_mc_5shot_len_norm,
        WandbMetrics.mmlu_social_sciences_mc_5shot_test_len_norm,
        WandbMetrics.mmlu_social_sciences_var_len_norm,
        WandbMetrics.mmlu_stem_mc_5shot_len_norm,
        WandbMetrics.mmlu_stem_mc_5shot_test_len_norm,
        WandbMetrics.mmlu_stem_var_len_norm,
    ]
    few_shot = [
        WandbMetrics.arc_challenge_mc_5shot_accuracy,
        WandbMetrics.arc_challenge_mc_5shot_bpb,
        WandbMetrics.arc_challenge_rc_5shot_bpb,
        WandbMetrics.arc_challenge_rc_5shot_len_norm,
        WandbMetrics.arc_easy_mc_5shot_accuracy,
        WandbMetrics.arc_easy_mc_5shot_bpb,
        WandbMetrics.arc_easy_rc_5shot_accuracy,
        WandbMetrics.arc_easy_rc_5shot_bpb,
        WandbMetrics.boolq_mc_5shot_accuracy,
        WandbMetrics.boolq_mc_5shot_bpb,
        WandbMetrics.boolq_rc_5shot_accuracy,
        WandbMetrics.boolq_rc_5shot_bpb,
        WandbMetrics.csqa_mc_5shot_accuracy,
        WandbMetrics.csqa_mc_5shot_bpb,
        WandbMetrics.csqa_rc_5shot_bpb,
        WandbMetrics.csqa_rc_5shot_len_norm,
        WandbMetrics.hellaswag_mc_5shot_accuracy,
        WandbMetrics.hellaswag_mc_5shot_bpb,
        WandbMetrics.hellaswag_rc_5shot_bpb,
        WandbMetrics.hellaswag_rc_5shot_len_norm,
        WandbMetrics.mmlu_humanities_mc_5shot_len_norm,
        WandbMetrics.mmlu_humanities_mc_5shot_test_len_norm,
        WandbMetrics.mmlu_other_mc_5shot_len_norm,
        WandbMetrics.mmlu_other_mc_5shot_test_len_norm,
        ...
        WandbMetrics.mmlu_stem_mc_5shot_len_norm,
        WandbMetrics.mmlu_stem_mc_5shot_test_len_norm,
        WandbMetrics.openbookqa_mc_5shot_accuracy,
        WandbMetrics.openbookqa_mc_5shot_bpb,
        WandbMetrics.openbookqa_rc_5shot_bpb,
        WandbMetrics.openbookqa_rc_5shot_len_norm,
        WandbMetrics.piqa_mc_5shot_accuracy,
        WandbMetrics.piqa_mc_5shot_bpb,
        WandbMetrics.piqa_rc_5shot_bpb,
        WandbMetrics.piqa_rc_5shot_len_norm,
        WandbMetrics.socialiqa_mc_5shot_accuracy,
        WandbMetrics.socialiqa_mc_5shot_bpb,
        WandbMetrics.socialiqa_rc_5shot_bpb,
        WandbMetrics.socialiqa_rc_5shot_len_norm,
        WandbMetrics.winogrande_mc_5shot_accuracy,
        WandbMetrics.winogrande_mc_5shot_bpb,
        WandbMetrics.winogrande_rc_5shot_accuracy,
        WandbMetrics.winogrande_rc_5shot_bpb,
    ]
