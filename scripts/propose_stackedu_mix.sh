...
: 'for R in 3 4 5
do
    rmc-eval fit -c src/regmixer/config/stackedu-5xC-30m-dense.yaml \
        -g fb40b847 \
        ...
        --constrain-objective \
        --manual-token-constraint-path src/regmixer/eval/stack_edu_requested_vs_available_tokens_dclmstackeduflatswarm_adjusted.yaml \
        --repetition-factor $R \
