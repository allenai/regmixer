...
for R in 4 #3 4 5
do
    rmc-eval fit -c src/regmixer/config/for_paper/backfill-5xC-30m-all-dressed-s2pdf.yaml \
        -g 6b8c165f \
        ...
        --constrain-objective \
        --manual-token-constraint-path src/regmixer/eval/superswarm_with_all_dressed_requested_vs_available_tokens.yaml \
        --repetition-factor $R \
