...
for R in 4
do 
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv2-to-s2pdfv1-minimum-exact-seed-0-6T.yaml \
        -g 24b53662 \
    ...
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv2-to-s2pdfv1-minimum-exact-seed-1-6T.yaml \
        -g 781995d6 \
        -G pretraining_tasks_for_paper \
        -a 1 \
        -S 100_000 \
    ...
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv2-to-s2pdfv1-minimum-exact-seed-2-6T.yaml \
        -g 61316814 \
        -G pretraining_tasks_for_paper \
        -a 1 \
        -S 100_000 \
