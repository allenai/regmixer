...
: 'for R in 4
do 
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv1-partitioned-exact-seed-1-6T.yaml \
        -g 7d23c1ca \
...
for R in 4
do 
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv1-partitioned-exact-seed-1-6T-final.yaml \
        -g 1bb8c9d8 \
        -G pretraining_tasks_for_paper \
        -a 1 \
        -S 100_000 \
