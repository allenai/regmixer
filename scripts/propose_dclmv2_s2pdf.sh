...
for R in 4 #3 4 5
do
    rmc-eval fit -c src/regmixer/config/for_paper/backfill-5xC-30m-dclmv2-s2pdf.yaml \
        -g ee22e17f \
        ...
        --constrain-objective \
        --manual-token-constraint-path src/regmixer/eval/superswarm_with_dclmv2_requested_vs_available_tokens.yaml \
        --repetition-factor $R \
