...
: 'for R in 4
do 
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv1-partitioned-exact-seed-2-6T.yaml \
        -g d1009266 \
...
for R in 4
do 
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv1-partitioned-exact-seed-2-6T-final.yaml \
        -g 57a58a3c \
        -G pretraining_tasks_for_paper \
        -a 1 \
        -S 100_000 \
