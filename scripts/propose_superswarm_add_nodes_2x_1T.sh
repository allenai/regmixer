...
do 
    ...
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-add-single-nodes-2x-exact-1T.yaml \
        -g ff8dc5b7 \
    ...
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-add-single-nodes-2x-exact-seed-1-1T.yaml \
        -g b29b0826 \
        -G pretraining_tasks_for_paper \
        -a 1 \
        -S 100_000 \
    ...
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-add-single-nodes-2x-exact-seed-2-1T.yaml \
        -g a0590a6a \
        -G pretraining_tasks_for_paper \
        -a 1 \
        -S 100_000 \
