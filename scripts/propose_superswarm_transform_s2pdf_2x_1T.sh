...
for R in 4
do 
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv2-to-s2pdfv1-2x-exact-seed-0-1T.yaml \
        -g 43d19ee8 \
    ...
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv2-to-s2pdfv1-2x-exact-seed-1-1T.yaml \
        -g e35ad143 \
        -G pretraining_tasks_for_paper \
        -a 1 \
        -S 100_000 \
    ...
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv2-to-s2pdfv1-2x-exact-seed-2-1T.yaml \
        -g 8f9ab978 \
        -G pretraining_tasks_for_paper \
        -a 1 \
        -S 100_000 \
