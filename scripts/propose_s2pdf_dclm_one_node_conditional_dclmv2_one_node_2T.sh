...
: 'for R in 4
do
    rmc-eval fit -c src/regmixer/config/for_paper/backfill-5xC-30m-s2pdf-dclm-one-node-conditional-dclmv2-one-node-2T.yaml \
        -g 38009761 \
        ...
        --constrain-objective \
        --manual-token-constraint-path src/regmixer/eval/superswarm_2T_collapse_dclmv2_s2pdf_stackedu_requested_vs_available_tokens.yaml \
        --repetition-factor $R \
