...
: 'for R in 4
do 
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-add-single-nodes-exact-seed-2-6T.yaml \
        -g 6d27efec \
...
# using diverse swarm the right way
for R in 4
do 
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-add-single-nodes-exact-seed-2-6T.yaml \
        -g 32e052cc \
