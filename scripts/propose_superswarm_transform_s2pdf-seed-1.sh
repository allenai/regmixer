...
do 
    ...
    : 'rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv2-to-s2pdfv1-exact-seed-1-6T.yaml \
        -g ca36bdc2 \
    ...
    rmc-eval fit -c  src/regmixer/config/for_paper/superswarm/backfill-5xC-30m-superswarm-s2pdfv2-to-s2pdfv1-exact-seed-1-6T-final.yaml \
        -g 80f83446 \
        -G pretraining_tasks_for_paper \
        -a 1 \
        -S 100_000 \
