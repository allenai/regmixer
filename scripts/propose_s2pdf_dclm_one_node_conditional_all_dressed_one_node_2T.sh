...
: 'for R in 4
do
    rmc-eval fit -c src/regmixer/config/for_paper/backfill-5xC-30m-s2pdf-dclm-one-node-conditional-all-dressed-one-node-2T.yaml \
        -g 57aa1c41 \
        ...
        --constrain-objective \
        --manual-token-constraint-path src/regmixer/eval/superswarm_2T_collapse_all_dressed_s2pdf_stackedu_requested_vs_available_tokens.yaml \
        --repetition-factor $R \
